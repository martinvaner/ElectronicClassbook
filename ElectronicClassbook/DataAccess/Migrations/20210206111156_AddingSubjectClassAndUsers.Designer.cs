...
namespace DataAccess.Migrations
{
    ...
    [Migration("20210206111156_AddingSubjectClassAndUsers")]
    partial class AddingSubjectClassAndUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParentStudent", b =>
                {
                    b.HasOne("DataAccess.EntityModel.Student", null)
                        .WithMany()
                        .HasForeignKey("ChildrensId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccess.EntityModel.Parent", null)
                        .WithMany()
